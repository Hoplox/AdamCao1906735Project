...
class TFRBertClient(object):    
    ...
    def generatePredictions(self, rankingProblemELWC, rankingProblemJSONIn):                
        ...
        #rankingProblemJSON['documents'] = rankingProblemJSON['documents'][:10]
    ...
    def generatePredictionsList(self, rankingProblemsELWC, rankingProblemsJSON):
        ...
        for idx in range(0, len(rankingProblemsELWC)):
            ...
            print ("\rPredicting " + str(idx+1) + " / " + str(len(rankingProblemsELWC)) + " (" + percentCompleteStr + "%)", end="")
...
def main():
    ...
    tfrBertClient = TFRBertClient(grpcChannel = "0.0.0.0:8500", modelName = "tfrbert", servingSignatureName = "serving_default", timeoutInSecs = 300)
